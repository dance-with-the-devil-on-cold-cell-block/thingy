...
export default function RegisterForm(){
    ...
    return (<form className="grid grid-cols-[30%_70%] font-medium" onSubmit={swagform}>
        ...
        <input className="col-span-2 md:col-span-1" type="email" name="email" autoComplete="email" value={emailValue} onChange={(e) => setEmail(e.target.value)} required/>
        <label className="col-span-2 md:col-span-1">Password</label>
        <input className="col-span-2 md:col-span-1" type={showPassword ? "text" : "password"} autoComplete="password" name="pw" value={pwValue} onChange={(e) => setPw(e.target.value)} required/>
